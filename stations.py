RADIO_STATIONS = [
    ...
    {
        "name": "Lofi 1",
        "url": "http://live.radiospinner.com/lfch-96",
    },
    {
        "name": "Lofi 2",
    ...
    {
        "name": "Lofi 6",
        "url": "https://live.proradiosonline.com/listen/lofi_radio/aac",
    },
    {
        "name": "Lofi 7",
...
TV_STATIONS = [
    ...
    {
        "name": "IRIB TV Amoozesh",
        "url": "https://cdn-bsht1c86.telewebion.com/amouzesh/live/576p/index.m3u8",
    },
    {
        "name": "IRIB TV IRINN",
    ...
    {
        "name": "IRIB TV Ofogh",
        "url": "https://cdn-bsht1c86.telewebion.com/ofogh/live/480p/index.m3u8",
    },
    {
        "name": "IRIB TV Omid",
        "url": "https://cdn-bsht1c86.telewebion.com/omid/live/576p/index.m3u8",
    },
    {
        "name": "IRIB TV Quran",
...
def get_radio_station_url(name: str):
    for item in RADIO_STATIONS:
        if item["name"] == name:
            return item["url"]
    return None
...
def get_tv_station_names():
    choices = []
    for item in TV_STATIONS:
        choices.append(item["name"])
    return choices


def get_tv_station_url(name: str):
    for item in TV_STATIONS:
        if item["name"] == name:
            return item["url"]
    return None
